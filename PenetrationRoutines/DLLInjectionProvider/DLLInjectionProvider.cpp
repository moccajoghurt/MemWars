...
bool DLLInjectionProvider::InjectDLL() {
    ...
    if (!PathFileExists(tempPath)) {
        ...
        results += "[-] This indicates that the target process is vulnerable to DLL injections but the injection failed for other reasons.\n";
    ...
    results += "[+] The target process is vulnerable to DLL injections.\n";
